...
var libErrorMessages = map[C.lib_error]string{
	...
	C.LIB_QC_ERROR:                        "Quorum change error",
	C.LIB_INVALID_PARTY_LIST:              "Invalid party list",
	C.LIB_INVALID_OLD_PARTY_LIST:          "Invalid old party list",
	C.LIB_INVALID_NEW_PARTY_LIST:          "Invalid new party list",
	C.LIB_KEY_EXPORT_ERROR:                "Key export error",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_1:  "Protocol abort and ban party 1",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_2:  "Protocol abort and ban party 2",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_3:  "Protocol abort and ban party 3",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_4:  "Protocol abort and ban party 4",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_5:  "Protocol abort and ban party 5",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_6:  "Protocol abort and ban party 6",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_7:  "Protocol abort and ban party 7",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_8:  "Protocol abort and ban party 8",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_9:  "Protocol abort and ban party 9",
	C.LIB_ABORT_PROTOCOL_AND_BAN_PARTY_10: "Protocol abort and ban party 10",
